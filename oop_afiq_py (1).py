...
Original file is located at
    https://colab.research.google.com/drive/1oo0AjXyka7qdw2nDXFzK1MteL7rOXgW4
"""
...
model_handler.encoding('Age')
model_handler.encoding('CreditScore')
model_handler.encoding('Balance')
model_handler.encoding('EstimatedSalary')
...
model_handler.save_model_to_file('oop_Afiq.pkl')